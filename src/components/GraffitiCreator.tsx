...
const DEFAULT_ADV_PARAMS: AdvancedParams = {
  fill: 'Solid Color',
  outline: 'Simple',
  shadow: 'Drop Shadow',
  depth: 'None',
...
const STYLES: { id: GraffitiStyle; label: string; description: string; color: string }[] = [
...
const ParamSelect = ({ label, value, options, setter }: { label: string, value: string, options: string[], setter: (v: string) => void }) => (
